...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StyleSheetServer", function() { return StyleSheetServer$1; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StyleSheetTestUtils", function() { return StyleSheetTestUtils$1; });
...
/* harmony import */ var string_hash__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! string-hash */ "./node_modules/string-hash/index.js");
/* harmony import */ var string_hash__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(string_hash__WEBPACK_IMPORTED_MODULE_12__);
...
var hashString = function hashString(string /* : string */, key /* : ?string */) {
    return (/* string */string_hash__WEBPACK_IMPORTED_MODULE_12___default()(string).toString(36)
    );
};
...
var _Form = _interopRequireDefault(__webpack_require__(/*! ./Form */ "./src/components/Form.js"));

var _User = _interopRequireDefault(__webpack_require__(/*! ./User */ "./src/components/User.js"));
...
function (_Component) {
  function App() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(App)).call.apply(_getPrototypeOf2, [this].concat(args))), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      users: []
      ...
      if (_this.nameValidation(name) && _this.emailValidation(email)) {
        ...
        console.log(_this.state.isNameValid);
        console.log(_this.state.isEmailValid);
      ...
      fetch(url + '/' + item, {
        ...
        var index = _this.state.users.map(function (user) {
          return user.id;
        }).indexOf(item);

        _this.state.users.splice(index, 1);
      ...
      fetch(url + '/' + item, {
        ...
        body: JSON.stringify({
          "name": _this.state.users[item - 1].name,
          "email": _this.state.users[item - 1].email,
          "subscribe": _this.state.users[item - 1].subscribe,
          "admin": _this.state.users[item - 1].admin
        })
      }).then(function (results) {
        return results.json();
      }).catch(function (error) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement(_Form.default, {
        ...
        isEmailValid: this.state.isEmailValid // isValid={this.state.isValid}

      }), _react.default.createElement("br", null), this.state.users.map(function (user) {
...
var _User = _interopRequireDefault(__webpack_require__(/*! ../styles/User */ "./src/styles/User.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var EmailError = function EmailError(props) {
  if (props.isEmailValid == false) {
    return _react.default.createElement("div", {
      className: (0, _aphrodite.css)(_User.default.error)
    }, "Email Error");
  } else {
    return '';
  }
...
var _NameError = _interopRequireDefault(__webpack_require__(/*! ./NameError */ "./src/components/NameError.js"));

var _EmailError = _interopRequireDefault(__webpack_require__(/*! ./EmailError */ "./src/components/EmailError.js"));
...
function (_Component) {
  function Form() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Form)).call.apply(_getPrototypeOf2, [this].concat(args))), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      ...
      var subscribe = e.target.checked;

      _this.setState({
        subscribe: subscribe
      });
    }), "onAdminChange", function (e) {
      var admin = e.target.checked;
      ...
      _this.props.onAdd(_this.state.name, _this.state.email, _this.state.subscribe, _this.state.admin);
  ...
  _createClass(Form, [{
    ...
    value: function render() {
      return _react.default.createElement("form", {
        ...
        className: (0, _aphrodite.css)(_User.default.container),
        noValidate: true
      }, _react.default.createElement("input", {
        className: (0, _aphrodite.css)(_User.default.input),
        type: "text",
        placeholder: "Name",
        value: this.state.name,
        onChange: this.onNameChange
      }), _react.default.createElement("br", null), _react.default.createElement(_NameError.default, {
        isNameValid: this.props.isNameValid // isValid={this.props.isValid}
      ...
      }), _react.default.createElement("br", null), _react.default.createElement(_EmailError.default, {
        isEmailValid: this.props.isEmailValid // isValid={this.props.isValid}

      }), _react.default.createElement("label", {
        htmlFor: "subscribe"
      }, "Subscribe"), _react.default.createElement("input", {
        className: (0, _aphrodite.css)(_User.default.checkbox),
        id: "subscribe",
        type: "checkbox",
        ...
        htmlFor: "admin"
      }, "Admin"), _react.default.createElement("input", {
        className: (0, _aphrodite.css)(_User.default.checkbox),
        id: "admin",
        type: "checkbox",
        ...
        className: (0, _aphrodite.css)(_User.default.button),
        type: "submit"
      }, "Register"));
    }
  }]);
...
var NameError = function NameError(props) {
...
var User = function User(props) {
  return _react.default.createElement("form", {
    ...
    className: (0, _aphrodite.css)(_User.default.deleteButton),
    type: "button",
    onClick: props.onDelete
  }, "Delete"), _react.default.createElement("button", {
    className: (0, _aphrodite.css)(_User.default.saveButton),
    type: "button",
    onClick: props.onSave
  }, "Save"), _react.default.createElement("input", {
    className: (0, _aphrodite.css)(_User.default.input),
    type: "text",
    placeholder: "Name",
    value: props.name,
    ...
    onChange: props.onSubscribeChange
  }), props.subscribe == true ? _react.default.createElement("div", {
    className: (0, _aphrodite.css)(_User.default.subscribedLabel)
  }, "Subscribed") : '', _react.default.createElement("input", {
    className: (0, _aphrodite.css)(_User.default.checkbox),
    type: "checkbox",
    checked: props.admin,
    onChange: props.onAdminChange
  }), props.admin == true ? _react.default.createElement("div", {
    className: (0, _aphrodite.css)(_User.default.adminLabel)
  }, "Admin") : '');
};
...
var Sheet = _aphrodite.StyleSheet.create({
  container: {
    margin: [15]
  },
  input: {
